...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void saveProduct() {
        ...
        //Just testing this one out...I WANT IT TO STOP HERE BUT IT WON'T!
        if(TextUtils.isEmpty(nameString) || TextUtils.isEmpty(priceString)) {
            Toast.makeText(this, "Name and Price can't be blank.",
                    Toast.LENGTH_SHORT).show();
            return;//EXITS OUT HERE IF THE NAME OR PRICE ARE BLANK
        } else {
            requiredFields = true;//NOW IT CAN EXIT OUT OF THE FIELDS
            //ELSE starts here
